...
# argParser.add_argument('-e', '--file', nargs='+', help="Enter file name")
# argParser.add_argument('-u', '--folder', nargs='+', help="Enter name of folder")
...
extract_artform( entities,aat,dcterms, rdf, edm, result_artForm)
extract_csv_creators( entities, result_artForm, result_creators_csv)

# if args.file and args.folder:
#     extract_artform(args.datasource, args.file)
# elif not args.entity and args.urls:
#     extract_artform(args.urls, entities)
# elif args.entity and not args.urls:
#     extract_artform(baseUrl, args.file)
# elif __name__ == '__main__' or args.default:
#     extract_artform(baseUrl, entities)